...
namespace DBContext
{
    public class ControlAsistenciaDBContext : DbContext
    {
        ...
        public DbSet<CentroTrabajo_> CentroTrabajo_ { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CentroTrabajo_>(entity =>
            {
                entity.HasKey(e => e.Id);
            });

            //Nuevo Centro Trabajo


            modelBuilder.Entity<CentroTrabajo_>().HasData(new CentroTrabajo_ { Id = new Guid("3af153fd-fe52-4fdb-8e8f-494f4df51752"), IdUnidadAdministrativa = new Guid("3af153fd-fe52-4fdb-8e8f-494f4df51752"), Nombre = "OFICIAL M" });
            ...
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("4b0240b3-98e7-4f86-881b-10f760c32f71"), Nombre = "AGENCIA ESTATAL DE INVESTIGACION", UR = "311" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("dbfcacdf-82c3-49cd-b035-f992aa39a4e0"), Nombre = "COORDINACION GENERAL DE ANALISIS DE INFORMACION", UR = "612" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("9bfcf217-97d8-469f-9652-d6741fce84a1"), Nombre = "COORDINACION GENERAL DE ASUNTOS JURIDICOS", UR = "626" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("30ebd546-ab4e-4cb6-8d0e-9623d50a7869"), Nombre = "COORDINACION GENERAL DE COLABORACION INTERINSTITUCIONAL", UR = "628" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("f9e1ead4-61d4-473e-a73a-a8389fc13e33"), Nombre = "COORDINACION GENERAL DE DESARROLLO INSTITUCIONAL", UR = "639" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("e7d58ae0-9a84-4cc6-889e-9a7fd9b078b4"), Nombre = "COORDINACION GENERAL DE ESTADISTICA Y SISTEMAS DE INFORMACION", UR = "629" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("6a8e78c6-a792-46b3-8a09-ef0d5eeccbae"), Nombre = "COORDINACION GENERAL DE GESTION DOCUMENTAL INSTITUCIONAL", UR = "630" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("0d9102d0-d3c8-4e18-a13d-21fdedb7d9d6"), Nombre = "COORDINACION GENERAL DE INVESTIGACION", UR = "632" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("6f3bc61c-6e7e-42b0-b89e-00b919d5a096"), Nombre = "COORDINACION GENERAL DE LITIGACION", UR = "633" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("c76d8cbc-34a8-47ad-a75a-7342eb11974f"), Nombre = "COORDINACION GENERAL DE MECANISMOS ALTERNATIVOS DE SOLUCION DE CONTROVERSIAS EN MATERIA PENAL", UR = "614" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("766edba0-def6-4c84-98ed-ee5329c8a055"), Nombre = "COORDINACION GENERAL DE SERVICIOS A LA COMUNIDAD", UR = "631" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("039c76d3-4ca7-4c63-aa74-cbc7e001553d"), Nombre = "DIRECCION GENERAL DE COMUNICACION ESTRATEGICA Y VINCULACION SOCIAL", UR = "636" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("4619dc4c-d498-4726-81a7-78d4d624d790"), Nombre = "DIRECCION GENERAL DE PLANEACION INSTITUCIONAL", UR = "635" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("58da64f2-2cb3-4912-b378-4b6b53e29a37"), Nombre = "DIRECCION GENERAL DE SEGURIDAD INSTITUCIONAL", UR = "634" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("32c97d34-0fd4-46a0-9366-67843e3864ee"), Nombre = "FISCALIA DE INVESTIGACION METROPOLITANA", UR = "204" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("32d4cca4-63fb-460d-8c7a-62a652346378"), Nombre = "FISCALIA DE INVESTIGACION REGIONAL", UR = "205" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("61e8ffa1-6e7a-4855-a5ba-437c8ea6a815"), Nombre = "FISCALIA ESPECIALIZADA DE ASUNTOS INTERNOS", UR = "224" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("da78b3f2-8cb2-4c60-ae7a-c390a99febfe"), Nombre = "FISCALIA ESPECIALIZADA DE COMBATE A LA CORRUPCION", UR = "217" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("d052658e-e743-478d-aa94-21f279ddde3d"), Nombre = "FISCALIA ESPECIALIZADA EN DERECHOS HUMANOS", UR = "202" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("dfafd2a3-a200-4f1e-aebd-f791bd14d879"), Nombre = "FISCALIA ESPECIALIZADA EN INVESTIGACION DE DELITOS DE ALTA INCIDENCIA", UR = "223" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("31a77f82-63e0-44c5-afea-337d6d8af47d"), Nombre = "FISCALIA ESPECIALIZADA EN INVESTIGACION DE DELITOS DE VIOLENCIA DE GENERO CONTRA LAS MUJERES", UR = "220" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("96559f1b-3880-4339-9c73-fed0ec116105"), Nombre = "FISCALIA ESPECIALIZADA EN INVESTIGACION DE DELITOS ELECTORALES", UR = "219" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("00fe8231-6879-4189-b706-e3abdf62d4b7"), Nombre = "FISCALIA ESPECIALIZADA EN INVESTIGACION DE LOS DELITOS DE DESAPARICION FORZADA DE PERSONAS Y DESAPARICION COMETIDA POR PARTICULARES", UR = "222" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("2c9b14d2-8868-49ac-a503-584f44b7a6a1"), Nombre = "FISCALIA ESPECIALIZADA EN INVESTIGACION DE LOS DELITOS DE OPERACIONES CON RECURSOS DE PROCEDENCIA ILICITA FISCALES Y RELACIONADOS", UR = "238" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("e1a28eb5-19d7-4aa6-a340-d6366c46118c"), Nombre = "FISCALIA ESPECIALIZADA EN INVESTIGACION DE SECUESTRO Y EXTORSION", UR = "203" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("3a719e2b-7777-4694-aceb-157be081f8b3"), Nombre = "FISCALIA GENERAL DEL ESTADO", UR = "101" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("b467dc5a-5fb0-4399-9740-5877f10ce814"), Nombre = "INSTITUTO DE CIENCIAS FORENSES", UR = "307" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("bbe7a98c-7420-43da-8a4a-e80d331f4517"), Nombre = "INSTITUTO DE FORMACION PROFESIONAL", UR = "509" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("1c52fb81-0802-49f1-ad79-f53a05fc65fa"), Nombre = "OFICIALIA MAYOR", UR = "206" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("98b8fe5f-ba52-45cc-a416-cd509356cef1"), Nombre = "OFICINA DEL FISCAL GENERAL", UR = "225" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("199240cf-7e2a-4f72-99f9-90a3d9e93ec1"), Nombre = "ORGANO INTERNO DE CONTROL", UR = "413" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("2c1dcd2b-da26-414b-9a97-652f0d2809a4"), Nombre = "UNIDAD DE TRANSPARENCIA", UR = "737" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("53f19eac-b8f3-4486-8be4-4ef56fcb5084"), Nombre = "UNIDAD ESPECIALIZADA EN MATERIA DE EXTINCION DE DOMINIO", UR = "621" });
            //modelBuilder.Entity<UnidadAdministrativa>().HasData(new UnidadAdministrativa { Id = new Guid("4f0f5406-572d-409c-8cf2-4add53fceb78"), Nombre = "VISITADURIA GENERAL", UR = "427" });
