...
namespace DBContext
{
    public class ControlAsistenciaDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("86faef5c-c599-468e-9cab-5068df98968b"), Nombre = "AGENCIA ESTATAL DE INVESTIGACION PUEBLA", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "AV. 25 ORIENTE  #1610 BELLA VISTA, PUEBLA, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("2a49391b-d72a-4d73-9317-16117fc94a06"), Nombre = "AGENCIA ESTATAL DE INVESTIGACION SAN MARTIN TEXMELUCAN", IdMunicipio = new Guid("4EC19346-41D3-4E07-8731-6B9FDC68E976"), Direccion = "CALLE VICENTE GUERRERO NO.714 COL, MORELOS SAN MARTIN TEXMELUCAN, CP.: 74020" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("c22e8e91-018f-44be-bedd-a8b0f38cc4c2"), Nombre = "AGENCIA ESTATAL DE INVESTIGACION SANTA RITA TLAHUAPAN", IdMunicipio = new Guid("F6B2C9A2-A8A0-457F-A618-F4FED4403FF6"), Direccion = "CALLE JOSE GALEANA NO. 200 COLONIA DOMINGO ARENAS, SANTA RITA TLAHUAPAN" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("ae099b62-672c-4415-9004-93c1c74d5afd"), Nombre = "AGENCIA ESTATAL DE INVESTIGACION TEZIUTLAN", IdMunicipio = new Guid("815DD755-5C1B-440F-90EB-52C6640F873C"), Direccion = "CALLE LERDO NÚMERO 205, ALTOS COL. CENTRO. ANEXO AL CERESO, TEZIUTLAN , PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("c489d9da-1218-4461-9da7-326496fd1077"), Nombre = "AGENCIA ESTATAL DE INVESTIGACION TLATLAUQUITEPEC", IdMunicipio = new Guid("34B45EC0-F95A-48AA-8FDB-CB3CD43849A7"), Direccion = "AV. INDEPENDENCIA NUM. 20 COL.CENTRO , TLATLAUQUITEPEC,PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("4d8abe43-1937-416b-8f68-24fed74fea74"), Nombre = "ALMACEN GENERAL", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CALLE ORQUIDEAS NO. 6141 COLONIA BUGAMBILIAS CP 72580" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("43dd6dd7-af83-4ffa-8b1e-07535629a708"), Nombre = "ARCHIVO Y BODEGA DE INDICIOS", IdMunicipio = new Guid("C95CE227-0FFA-4EAE-B23E-BDD3C19BC822"), Direccion = "KM 19.5 CARRETERA FEDERAL PUEBLA - TEHUACAN, COLONIA SAN JOSE LAS FLORES, CP 72980, AMOZOC" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("35cd283f-9d4d-4bb8-98e5-63491a3995b7"), Nombre = "ARCO DE SEGURIDAD DE ALTEPEXI", IdMunicipio = new Guid("0C53A94F-3779-46B9-AA25-1BFE43C046E4"), Direccion = "CARRETERA ESTATAL TEHUACAN TEOTITLÁN OAXACA, TRAMO DE CHILACALTEPEXI,CP.: 75914" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("32e6d930-52ef-4fdc-86f9-2215885f629c"), Nombre = "ARCO DE SEGURIDAD DE IZUCAR DE MATAMOROS", IdMunicipio = new Guid("D26D3CE6-9743-497B-A8F3-F267E49918FB"), Direccion = "CARRETERA FEDERAL IZÚCAR DE MATAMOROS KM61+800 IZUCAR DE MATAMOROS" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("6a67a22a-f681-4ebb-9548-0528dfa0f5e9"), Nombre = "ARCO DE SEGURIDAD HUEJOTZINGO", IdMunicipio = new Guid("57FC7F0D-F60D-4B2B-A9AA-EACB174D7592"), Direccion = "CARRETERA MÉXICO -PUEBLA KM100+200 HUEJOTZINGO ,PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("e55ba7b6-e627-43c0-9abb-d1bf1204613c"), Nombre = "ARCO DE SEGURIDAD PALMAR DE BRAVO", IdMunicipio = new Guid("45D33258-4F97-4CED-99A1-467449EF159D"), Direccion = "CARRETERA MÉXICO VERACRUZ KM 166+500PALMAR DE BRAVO , PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("c9ceffdd-1e0e-4b94-a33c-e4108ec1f8f5"), Nombre = "C5 TEHUACAN", IdMunicipio = new Guid("829D477C-F775-4C88-9953-85D22BA08598"), Direccion = "CARRETERA FEDERAL PUEBLA TEHUACAN 1211 O KM 114 SAN LORENZO TEOTIPILCO, TEHUACAN, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("5923324d-6a3c-441c-9f74-adf695267e6d"), Nombre = "CANACO SAN MARTIN TEXMELUCAN", IdMunicipio = new Guid("4EC19346-41D3-4E07-8731-6B9FDC68E976"), Direccion = "REFORMA 3 ORIENTE, COL. CENTRO 74000 SAN MARTIN TEXMELUCAN, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("817608ad-cded-49e7-be3b-81cc04b7401c"), Nombre = "CASA DE JUSTICIA ACATLAN DE OSORIO", IdMunicipio = new Guid("B8C23BFB-5297-4C64-B49D-6BCAA97F1D12"), Direccion = "CARRETERA INTERNACIONAL MÉXICO -OAXACA KM152+200, BARRIO LA PALMA , ACATLÁN DE OSORIO PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("0442f3e8-e17e-44f8-aa43-d164ec3c2196"), Nombre = "CASA DE JUSTICIA ATLIXCO", IdMunicipio = new Guid("0297D60E-31E1-4CB7-973A-A9F9104E7DC9"), Direccion = "BOULEVARD GENERAL MORENO VALLE NO. 1604, COL. TIZAYUCA ,ATLIXCO PUE. CP.: 74200" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("eef0d647-5115-4f28-8fe0-50388e7b4291"), Nombre = "CASA DE JUSTICIA CHALCHICOMULA DE SESMA", IdMunicipio = new Guid("F751758F-84AD-43AD-A5D5-B51400FFA92C"), Direccion = "KM.28+285 CARRETERA FEDERAL EL SECO ASUMBULLA, CD. SERDAN, PUEBLA CP.: 75520" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("c3dd79a1-3263-46f2-8d0b-575f7a08e503"), Nombre = "CASA DE JUSTICIA HUAUCHINANGO", IdMunicipio = new Guid("2D3DE914-B664-4219-9FAA-675431C332B7"), Direccion = "CAMINO A CATALINA S/N COLONIA EL POTRO, HUAUCHINANGO, PUEBLA CP.: 73176" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("ee0b2891-7258-4862-ade6-1fab11ca52d6"), Nombre = "CASA DE JUSTICIA IZUCAR DE MATAMOROS", IdMunicipio = new Guid("D26D3CE6-9743-497B-A8F3-F267E49918FB"), Direccion = "CARRETERA FEDERAL PUEBLA-IZUCAR DE MATAMOROS NO. 2119, COL. GALARZA, IZUCAR" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("d4c0b644-34b1-4f12-b376-05d3b44915b0"), Nombre = "CASA DE JUSTICIA PARA ADOLESCENTES", IdMunicipio = new Guid("53C9635E-F7A6-45DC-A252-D1CD45D5F42C"), Direccion = "CARRETERA IZUCAR DE MATAMOROS S/N COL. TLAXCALANCINGO, CP.: 72820" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("0d921954-c36f-417d-9078-74d15cbd42d2"), Nombre = "CASA DE JUSTICIA SAN ANDRES CHOLULA", IdMunicipio = new Guid("53C9635E-F7A6-45DC-A252-D1CD45D5F42C"), Direccion = "PERIFÉRICO ECOLÓGICO 100 SAN BERNARDINO TLAXCALANCINGO SAN ANDRES CHOLULA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("c2556996-44b5-4a78-a88e-5acc70b06163"), Nombre = "CASA DE JUSTICIA SAN MARTIN TEXMELUCAN", IdMunicipio = new Guid("4EC19346-41D3-4E07-8731-6B9FDC68E976"), Direccion = "AUTOPISTA MÉXICO -PUEBLA S/N, SAL SALVADOR EL VERDE, SAN MARTIN TEXMELUCAN," });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("5b80ce18-1931-4017-a3df-4f731e55da9e"), Nombre = "CASA DE JUSTICIA TECAMACHALCO", IdMunicipio = new Guid("16656BD5-EA70-46A9-ADC2-ACD89CC2FB63"), Direccion = "CARRETERA FEDERAL KM 60+490, COL.SANTIAGO ALSESECA, TECAMACHALCO, CP.: 75480" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("f03ad1cb-4530-43af-a9ac-12212b059695"), Nombre = "CASA DE JUSTICIA TEHUACAN", IdMunicipio = new Guid("829D477C-F775-4C88-9953-85D22BA08598"), Direccion = "BLVD. ADOLFO MATEOS NO.4, PLANTA ALTA, COL. ZONA ALTA, TEHUACAN, PUEBLA CP.: 75750" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("74d5b97d-f95e-4b14-911b-c1343ede1c0d"), Nombre = "CASA DE JUSTICIA TEZIUTLAN", IdMunicipio = new Guid("815DD755-5C1B-440F-90EB-52C6640F873C"), Direccion = "CALLE LA MESILLA NO.10 COL. INDUSTRIAL, TEZIUTLÁN, PUEBLA. CP.: 73850" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("bd85704f-98a4-4daf-bbf7-bd1211316567"), Nombre = "CASA DE JUSTICIA ZACATLAN", IdMunicipio = new Guid("768AFF2F-8946-45FF-BA24-D0065B01B7DE"), Direccion = "LIBRAMIENTO CARRETERA ZACATLAN -TEJOCOTAL, BARRIO DE MAQUIXTLA, ZACATLAN," });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("9d8e4d47-06d4-4e15-804c-f9ede4053020"), Nombre = "CENTRO DE JUSTICIA PARA LAS MUJERES EN ACATLAN DE OSORIO", IdMunicipio = new Guid("B8C23BFB-5297-4C64-B49D-6BCAA97F1D12"), Direccion = "AV. REFORMA 22 COLONIA CENTRO ENTRE EMILIANO ZAPATA Y VENUSTIANO C" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("3a4848a7-6d62-40db-afba-071e803742fb"), Nombre = "CENTRO DE JUSTICIA PARA LAS MUJERES PUEBLA", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CALLE 17 PONIENTE NO.1919, BARRIO DE SANTIAGO,PUEBLA, PUE. CP.: 72410" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("231e0dc8-b629-4c1b-879c-4e423c0b00ae"), Nombre = "CENTRO DE JUSTICIA PARA LAS MUJERES TEHUACAN", IdMunicipio = new Guid("829D477C-F775-4C88-9953-85D22BA08598"), Direccion = "CALLE COMPLUTENSE ESQUINA CALLE DE LA TURBINA S/N COL. UNIVERSIDADES II, TEHUACAN ,PUE. CP.: 75723" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("d96e493c-bfc6-407a-8b46-bd91785b12da"), Nombre = "CENTRO INTEGRAL DE SERVICIOS ANGELOPOLIS", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "VÍA ATLIXCAYOTL NO. 1101, EDIFICIO SUR PLANTA BAJA , CONCEPCION LAS LAJAS , PUEBLA,PUE" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("7acc637a-3dd0-44b5-a019-cbeb7c2c9909"), Nombre = "CENTRO INTEGRAL DE SERVICIOS CUAUTLANCINGO", IdMunicipio = new Guid("9005DDCE-0399-4CAB-8496-456B816BCFEB"), Direccion = "CALLE AQUILES SERDAN ESQUINA CON 20 DE NOVIEMBRE SIN NUMERO, COLONIA BELLO HORIZONTE, CUAUTLANCINGO" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("c8dcc246-a31f-43fe-a862-617aee1ffabf"), Nombre = "CENTRO INTEGRAL DE SERVICIOS SAN JAVIER", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "AV. REFORMA 1305 COL CENTRO C.P. 72000" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("2a97a757-952c-44bd-a23c-adfbd8d2ccc3"), Nombre = "CENTRO INTEGRAL DE SERVICIOS TEZIUTLAN", IdMunicipio = new Guid("815DD755-5C1B-440F-90EB-52C6640F873C"), Direccion = "AV HIDALGO NO.169 EDIFICIO REAL PLANTA BAJA, CENTRO. TEZIUTLAN, PUEBLA." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("b7286921-dcaa-44a6-ac84-5cfa8df62a38"), Nombre = "CENTRO INTEGRAL DE SERVICIOS TLATLAUQUITEPEC", IdMunicipio = new Guid("34B45EC0-F95A-48AA-8FDB-CB3CD43849A7"), Direccion = "CARRETERA FEDERAL TEZIUTLAN - ACAJETE NO. 169 BARRIO DE CONTLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("ba454f9d-8ce3-4656-99f1-6ad4ff275a38"), Nombre = "CENTRO INTEGRAL SERVICIOS ATLIXCO", IdMunicipio = new Guid("0297D60E-31E1-4CB7-973A-A9F9104E7DC9"), Direccion = "REVOLUCIÓN NO. 6202, COL. EL LEÓN ATLIXCO PUE, CP.: 74360" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("aec14e3c-9860-4bc9-9d55-7a4104d287e6"), Nombre = "CENTRO INTEGRAL SERVICIOS SAN JOSE CHIAPA", IdMunicipio = new Guid("26935263-7F17-4DB2-BFB7-908CD3CBAD54"), Direccion = "MANZANA NÚMERO 5 CIUDAD MODELO" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("b6cde2c8-e194-4aed-8a78-f8fddc84ff99"), Nombre = "CENTRO INTEGRAL SERVICIOS TEHUACAN", IdMunicipio = new Guid("829D477C-F775-4C88-9953-85D22BA08598"), Direccion = "CARRETERA FEDERAL PUEBLA - TEHUACÁN KILOMETRO 114, MANANTIALES, TEHUACÁN, PUE. CP.: 75855" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("3944958b-8410-4897-8391-5363f1f4eb60"), Nombre = "COMPLEJO DE SEGURIDAD PUBLICA SAN ANDRES CHOLULA", IdMunicipio = new Guid("53C9635E-F7A6-45DC-A252-D1CD45D5F42C"), Direccion = "CAMINO A CUAYANTLA NO. 1611, SAN BERNARDINO TLAXCALANCINGO, PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("906c3847-f152-46db-bd73-ddc8402aeac3"), Nombre = "COMPLEJO METROPOLITANO SEGURIDAD PUBLICA (C5)", IdMunicipio = new Guid("9005DDCE-0399-4CAB-8496-456B816BCFEB"), Direccion = "PERIFERICO ECOLÓGICO KILÓMETRO 3.5 ANTIGUO CAMINO A SAN FRANCISCO OCOTLÁN, CUAUTLANCINGO PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("5fe2bcc7-9dd4-455e-a33d-8b49207566e4"), Nombre = "COORDINACION GENERAL DE ANALISIS DE INFORMACION", IdMunicipio = new Guid("53C9635E-F7A6-45DC-A252-D1CD45D5F42C"), Direccion = "TERCER RETORNO OSA MAYOR NO. 3, RESERVA TERRITORIAL ATLIXCAYOTL SAN ANDRES" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("26822c2c-9135-4af5-a63a-ea4a0e4934a4"), Nombre = "COORDINACION GENERAL DE MECANISMOS ALTERNATIVOS DE SOLUCION DE CONTROVERSIAS EN MATERIA PENAL", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "DIAGONAL DEFENSORES DE LA REPÚBLICA ESQ.10 PONIENTE COL.AMOR PUEBLA,PUE. CP.: 72140" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("7c992159-0c85-4110-8745-6f8da050e0b3"), Nombre = "DEPOSITO DE VEHICULOS OCRA - SAN MIGUEL 2", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CAMINO AL BATÁN COL.LOMAS DE SAN MIGUEL PUEBLA,PUE" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("e40182a5-a033-427e-b163-ee1946dc0cc0"), Nombre = "DEPOSITO DE VEHICULOS SANCTORUM (FINSA)", IdMunicipio = new Guid("9005DDCE-0399-4CAB-8496-456B816BCFEB"), Direccion = "RIO ATOYAC # 19 SANCTORUM" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("a6dd37bf-a43e-4aa2-ba45-6d9b2810699a"), Nombre = "EDIFICIO CENTRAL 04", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "BOULEVARD HEROES 5 DE MAYO ESQUINA CON 31 ORIENTE COL.LADRILLERA DE BENITEZ CP.: 72530" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("29972aa4-57f4-4656-8e53-ab61dfd801e0"), Nombre = "EJECUCION DE SENTENCIAS", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "KM 2.5 CARRETERA AL BATAN , EDIFICIO ADJUNTO AL CERESO DE SAN MIGUEL PUEBLA,PUE" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("ac575287-cfbb-45d7-8c26-35ed54b52c28"), Nombre = "FISCALIA DE ASUNTOS INTERNOS, ORGANO INTERNO DE CONTROL Y VISITADURIA", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "12 NORTE. NO.1806,COL. BARRIO DEL ALTO , PUEBLA PUE. CP.: 72146" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("ae527c47-f179-452a-a18f-8c66fa4dd40a"), Nombre = "FISCALIA DE DERECHOS HUMANOS", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CALLE 12 ORIENTE NO. 415 COL. CENTRO, PUEBLA, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("abcc02e1-3c54-44f0-9f84-c67f6c9cc6a6"), Nombre = "FISCALIA ESPECIALIZADA DE COMBATE A LA CORRUPCION, FISCALIA ESPECIALIZADA EN INVESTIGACION DE LOS DELITOS DE DESAPARICION FORZADA DE PERSONAS Y DESAPARICION COMETIDA POR PARTICUALRES", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "AVENIDA 16 DE SEPTIEMBRE NUMERO 2904 COLONIA EL CARMEN, PUEBLA, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("1f4f78ed-08e2-403d-a2eb-2f7f150b64a1"), Nombre = "FISCALIA ESPECIALIZADA EN INVESTIGACION DE DELITOS DE ALTA INCIDENCIA", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CALLE 127 PONIENTE Y CALLE 11 SUR , COL.EX-HACIENDA CASTILLOTLA, PUEBLA,PUE" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("b54e17a8-ee08-4850-b580-4fefbefe63e9"), Nombre = "FISCALIA ESPECIALIZADA EN INVESTIGACION DE DELITOS DE VIOLENCIA DE GENERO CONTRA LAS MUJERES (BOCHAS)", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CALLE 6 NORTE NO.1003, COL. CENTRO,PUEBLA PUE. CP.: 72000" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("2b63384c-922a-43c4-be93-95ce246ae250"), Nombre = "FISCALIA ESPECIALIZADA EN INVESTIGACION DE DELITOS DE VIOLENCIA DE GENERO CONTRA LAS MUJERES (CPJ)", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CALLE 10 ORIENTE NO.414,COL CENTRO PUEBLA,PUE. CP.: 72530" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("6670a4d5-b95f-4c75-97de-095a4dd656e3"), Nombre = "FISCALIA ESPECIALIZADA EN INVESTIGACION DE SECUESTRO Y EXTORSION", IdMunicipio = new Guid("53C9635E-F7A6-45DC-A252-D1CD45D5F42C"), Direccion = "3ER RETORNO OSA MENOR NO.3, RESERVA TERRITORIAL ATLIXCAYOTL ,SAN ANDRÉS" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("b2ee847d-345f-4d48-9d2d-54eae90c316f"), Nombre = "INDIGENAS PERIODISTAS LGBTTQ", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "PRIV. 5 B SUR NO. 3706, COL. GABRIEL PASTOR, PUEBLA, PUE CP. 72420" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("470a7031-d5f8-4558-9550-0867a73a045f"), Nombre = "INMUEBLE CANACINTRA", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "AV. REFORMA 2704 5° PISO COL. AMOR" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("2f113507-a75a-4c50-8c91-4ac729fbd1d9"), Nombre = "INSTITUTO DE FORMACION PROFESIONAL", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "DIAGONAL CUAUHTÉMOC NO.3101 COL. VALLE DORADO PUEBLA,PUE. CP.: 72070" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("a49efd5e-dc5b-4f7d-9a5c-dd60d03242f0"), Nombre = "JUSTICIA CIUDADANA", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "13 SUR 1910 BARRIO DE SANTIAGO PUEBLA PUE" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("d69b3d73-bfde-4a70-bafb-fe3b86cd7172"), Nombre = "SEMEFO 11 SUR", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "PROLONGACION 11 SUR 11906, COL. GUADALUPE HIDQLGO" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("5940ec9b-adb5-4f86-b41a-8f1e8f9d0a02"), Nombre = "SEMEFO CHIGNAHUAPAN", IdMunicipio = new Guid("796FE037-7C39-48A1-BE38-3D883E228409"), Direccion = "BOULEVARD EMILIANO ZAPATA SIN NUMERO, INTERIOR DEL PANTEON MUNICIPAL, CHIGNAHUAPAN,PUEBLA " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("0e939264-1603-4871-b6ae-dedff5194ade"), Nombre = "SEMEFO LIBRES", IdMunicipio = new Guid("9A631574-5367-4DBE-B233-D9B4FA2D4CC3"), Direccion = "CALLE 4 ORIENTE SIN NUMERO BARRIO DE GUADALUPE " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("0b659f2c-0b54-4c9a-9913-1b5f8e3eaca7"), Nombre = "SEMEFO TEPEACA", IdMunicipio = new Guid("D5B17B0B-1B1C-4B65-983D-113AD6D561FB"), Direccion = "INTERIOR DEL PANTEON MUNICIPAL, CALLE 17 ORIENTE Y AVENIDA COLON SIN NUMERO, BARRIO EL  SANTUARIO  " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("42fc32a7-16ab-4f67-ac30-65cda4390e0c"), Nombre = "SEMEFO TEPEXI DE RODRIGUEZ", IdMunicipio = new Guid("D94A72C8-8670-4344-AB47-A78C2FEFADEF"), Direccion = "PANTEON MUNICIPAL CALLE DEFENSORES DEL 6 DE JUNIO SIN NUMERO, TEPEXI DE  RODRIGUEZ " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("4dce731d-8307-488a-ace3-3b3df5a67e8f"), Nombre = "SEMEFO TLATLAUQUITEPEC", IdMunicipio = new Guid("34B45EC0-F95A-48AA-8FDB-CB3CD43849A7"), Direccion = "AV DOLORES BETANCOURT COL. CONTLA, TLATLAUQUITEPEC, PUEBLA " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("10997793-0f57-4bdb-baf7-1403fd39da1a"), Nombre = "SEMEFO XICOTEPEC DE JUAREZ", IdMunicipio = new Guid("8E77A494-CE8B-4500-B883-CB24E774D350"), Direccion = "AV. ZARAGOZA SIN NUMERO, XICOTEPEC DE JUAREZ  " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("edf15099-8429-4c1a-81b3-f04fe1e531b5"), Nombre = "SEMEFO ZACAPOAXTLA", IdMunicipio = new Guid("7EC98118-CD95-440E-AE88-3E8FBB68486B"), Direccion = "CALLE 2 DE ABRIL NORTE  SIN NUMERO ESUINA FJ. ARRIAGA COL. CENTRO ZACAPOAXTLA, PUEBLA " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("081ad4bb-7d11-4843-beb7-c07826d85a53"), Nombre = "SEMEFO ZACATLAN", IdMunicipio = new Guid("768AFF2F-8946-45FF-BA24-D0065B01B7DE"), Direccion = "CALLE PORFIRIO DIAZ Y DOLORES PEREZ SIN NUMERO COL. CENTRO  ZACATLAN, PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("36cb41c4-7b3b-4cc3-9f13-fcf8e0b24911"), Nombre = "UNIDAD DE IDENTIFICACION VEHICULAR", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "EMILIANO ZAPATA KM2.5,COL LOMAS DE SAN MIGUEL,PUEBLA,PUE. CP.: 72573" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("166018d2-ade9-436f-a5af-1af52d0bcb26"), Nombre = "UNIDAD DE INVESTIGACION ACAJETE", IdMunicipio = new Guid("0B476639-85D3-4931-9394-3D10B3B40648"), Direccion = "CALLE 2 ORIENTE ENTRE CALLE 8 NORTE Y CALLE 10 ORIENTE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("cc329083-4776-4638-8086-775c481f963b"), Nombre = "UNIDAD DE INVESTIGACION ACATENO", IdMunicipio = new Guid("883FD478-E136-4504-A096-1B8D30AB8639"), Direccion = "CALLE ALLENDE NO. 1 COL. CENTRO SAN JOSÉ ACATENO" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("b8f41d8f-48cc-4433-b522-c456c2f0ccc7"), Nombre = "UNIDAD DE INVESTIGACION ACATZINGO", IdMunicipio = new Guid("0DDFE43E-A48A-4F89-BCE3-CE093D05C35F"), Direccion = "AV. IGNACIO ROMERO VARGAS 201 COL CENTRO CP 75150" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("ffbdd143-c626-44bc-95b1-2adea48a93cc"), Nombre = "UNIDAD DE INVESTIGACION ADSCRITA A JUZGADOS PENALES Y CIVILES", IdMunicipio = new Guid("57FC7F0D-F60D-4B2B-A9AA-EACB174D7592"), Direccion = "AV DE LAS HUERTAS 917 CUARTO BARRIO COL. CENTRO, HUEJOTZINGO, PUEBLA, CP.: 74168" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("8baf2105-80db-4cdb-91e0-c66011dacef4"), Nombre = "UNIDAD DE INVESTIGACION AHUAZOTEPEC", IdMunicipio = new Guid("7C58F0BA-3D86-4743-A359-75DF6FDBC64F"), Direccion = "CALLE HIDALGO SUR  S/N COL. CENTRO (DENTRO DE LA PRESIDENCIA MUNICIPAL " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("95d58c81-96ab-49c6-a005-13ab7ec30d6a"), Nombre = "UNIDAD DE INVESTIGACION AJALPAN", IdMunicipio = new Guid("4B97A0D5-3DA2-4A2C-97E5-EB0ED561299D"), Direccion = "CALLE GUERRERO SIN NÚMERO, AJALPAN PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("890a91a4-3d44-44ff-a21f-a7089583a9e6"), Nombre = "UNIDAD DE INVESTIGACION AMOZOC", IdMunicipio = new Guid("C95CE227-0FFA-4EAE-B23E-BDD3C19BC822"), Direccion = "CALLE FRANCISCO I. MADERO 109 COLONIA CENTRO BARRIO DE SANTIAGO, AMOZOC, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("6fe8cf46-c22c-4301-9c35-881fc048761f"), Nombre = "UNIDAD DE INVESTIGACION ATEMPAN", IdMunicipio = new Guid("C5C10FF1-A75C-432E-B5DF-96086CDFE47B"), Direccion = "02 ORIENTE SIN NUMERO, COLONIA CENTRO, ATEMPAN, PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("94fba396-5ece-4f20-8eb8-0caa781d101d"), Nombre = "UNIDAD DE INVESTIGACION ATENCINGO", IdMunicipio = new Guid("61203FD8-1089-478E-8061-78D51358C7AD"), Direccion = "CALLE 5 DE FEBRERO ESQUINA MIGUEL HIDALGO COL LA CRUZ" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("12c4aa2a-e64d-4bc2-a3a4-d1ff942df174"), Nombre = "UNIDAD DE INVESTIGACION CALPAN", IdMunicipio = new Guid("974EC286-E9D0-4DDD-9ADB-60E0364C8A9C"), Direccion = "CALLE CONSTITUCION S/N ENTRE 16 DE SEPTIEMBRE Y DOMINGO ARENAS, PRESIDENCIA MUNICIPAL CALPAN, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("e68ccb92-e995-42fd-9901-b54da7d420d7"), Nombre = "UNIDAD DE INVESTIGACION CENTRO", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "9 ORIENTE NO.1405COL.CENTRO PUEBLA PUE" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("ce540b67-7abe-47ba-9380-3bbb513872d6"), Nombre = "UNIDAD DE INVESTIGACION CHAPULCO", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "PROLONGACION DE LA 14 SUR NUMERO 11517 COL. SAN JOSE CHAPULCO" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("94b17059-9058-4cdf-85ca-3d1bd9417ba4"), Nombre = "UNIDAD DE INVESTIGACION CHIAUTLA DE TAPIA", IdMunicipio = new Guid("76A59C1C-6538-4A5B-9D55-4ED081309A70"), Direccion = "CALLE REFORMA Y 5 NORTE COLONIA CENTRO, CHIAUTLA DE TAPIA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("518e67c8-5797-481c-8491-426d21208051"), Nombre = "UNIDAD DE INVESTIGACION CHIETLA", IdMunicipio = new Guid("6DC36E6E-8182-4A61-8C1A-83D03D36A673"), Direccion = "CALLE RAYON NUMERO 4 COL. CENTRO" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("88c35b48-5a08-44ec-9fe5-8bbc8c079aa6"), Nombre = "UNIDAD DE INVESTIGACION CHIGNAHUAPAN", IdMunicipio = new Guid("796FE037-7C39-48A1-BE38-3D883E228409"), Direccion = "LIBRAMIENTOCHIGNAHUAPAN - ZACATLAN, KM 4.5 BARRIO TOLTEMPAN, CHIGNAHUAPAN, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("c0f29f24-7a1f-42eb-a70c-e22ac331623f"), Nombre = "UNIDAD DE INVESTIGACION CIUDAD JUDICIAL", IdMunicipio = new Guid("53C9635E-F7A6-45DC-A252-D1CD45D5F42C"), Direccion = "PERIFERICO ECOLOGÍCO ARCO SUR NO. 4000, RESERVA TERRITORIAL ATLIXCAYOTL, SAN" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("42b27b63-67ce-44fc-80c6-3321395855af"), Nombre = "UNIDAD DE INVESTIGACION CORONANGO", IdMunicipio = new Guid("4AEF29CC-0F44-4E25-A704-902804424E41"), Direccion = "AV. 5 DE FEBRERO NORTE SIN NUMERO COL. EL MONTERO CORONANGO, PUEBLA  COMPLEJO METROPOLITANO" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("cd9a05fa-bcd1-4d74-9b81-0adb0e4151d0"), Nombre = "UNIDAD DE INVESTIGACION CRIMINAL Y UNIDAD DE ATENCION TEMPRANA IZUCAR DE MATAMOROS", IdMunicipio = new Guid("D26D3CE6-9743-497B-A8F3-F267E49918FB"), Direccion = "PRIVADA UNIVERSIDAD II SAN MARTIN ALCHICHICA, IZUCAR DE MATAMOROS,PUEBLA " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("4bc24de3-9b1e-4643-897d-42bc54715527"), Nombre = "UNIDAD DE INVESTIGACION CRIMINAL Y UNIDAD DE ATENCION TEMPRANA ZACATLAN", IdMunicipio = new Guid("768AFF2F-8946-45FF-BA24-D0065B01B7DE"), Direccion = "LIBRAMIENTO CARRETERA ZACATLAN -TEJOCOTAL, BARRIO DE MAQUIXTLA, ZACATLAN, PUEBLA CP.: 73310" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("e856efb6-ce67-46ea-9323-8f581a573449"), Nombre = "UNIDAD DE INVESTIGACION CUAUTLANCINGO", IdMunicipio = new Guid("9005DDCE-0399-4CAB-8496-456B816BCFEB"), Direccion = "CALLE CAMINO NACIONAL ESQUINA CON AQUILES SERDAN SIN NUMERO, COLONIA BELLO HORIZONTE, CUAUTLANCINGO  COMPLEJO DE SEGURIDAD" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("fdb7e17c-f640-4fb4-a7e7-0311f7c07c66"), Nombre = "UNIDAD DE INVESTIGACION CUETZALAN DEL PROGRESO", IdMunicipio = new Guid("54870E6A-687E-4ED5-8882-E6CC3D2F3A3C"), Direccion = "CALLE MIGUEL ALVARADO ESQUINA CON ABASOLO S/N COLONIA CENTRO C.P. 75040 CUETZALAN PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("30066563-43ea-4af7-bfdb-b0dd1ee0d909"), Nombre = "UNIDAD DE INVESTIGACION EL SECO", IdMunicipio = new Guid("22A067FB-BAC4-42D9-89F4-54EAF6995A45"), Direccion = "AV. 4 ORIENTE SIN NUMERO TECOAC" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("9d70cbeb-0807-4b6f-a71c-15b96ad94b2e"), Nombre = "UNIDAD DE INVESTIGACION ESPERANZA", IdMunicipio = new Guid("51D0E71C-1CE2-4874-8EEB-57080CA1BD7B"), Direccion = "CALLE 12 NORTE SEGUNDA SECCION 22, ESPERANZA, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("c8f9bd48-19d6-4f0b-8c23-ab5128434e03"), Nombre = "UNIDAD DE INVESTIGACION HUEHUETLA", IdMunicipio = new Guid("2603582A-751A-4FBC-8391-E6168F3AFAFC"), Direccion = "CALLE JUAREZ SUR S/N COL. YALU LOCALUDAD PUTAX-EAT, HUEHUETLA, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("73f5d8bf-2df3-482e-91ae-54cc4480dc3c"), Nombre = "UNIDAD DE INVESTIGACION HUEYTAMALCO", IdMunicipio = new Guid("C0A081C3-7BB4-49A6-80A5-C0AB374FE23B"), Direccion = "CALLE INDEPENDENCIA ESQ. CON CALLE 5 DE MAYO S/N COL. CENTRO, HUEYTAMALCO, PUE" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("7925bce4-5dca-40fb-be6e-caafda3b66bd"), Nombre = "UNIDAD DE INVESTIGACION JUAN C BONILLA", IdMunicipio = new Guid("EFCDDCBA-B5D6-4331-B9DE-5A80228C3327"), Direccion = "CALLE 5 DE MAYO S/N COLONIA CENTRO, JUAN C. BONILLA, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("7fa95fca-a86b-4380-a8a7-86c4ac3ecb01"), Nombre = "UNIDAD DE INVESTIGACION LA MARGARITA", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CAMINO AL BATAN NO. 12 COL. VILLA SATELITE LA CALERA PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("8e5fb0dc-35e8-4857-9218-612710307c68"), Nombre = "UNIDAD DE INVESTIGACION LA POPULAR", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "AV.105 PONIENTE ENTRE CALLE PUEBLA Y OAXACA COL.POPULAR CASTILLOTLA, PUEBLA," });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("7722c32d-f365-4feb-b137-6807a0f92693"), Nombre = "UNIDAD DE INVESTIGACION LAZARO CARDENAS", IdMunicipio = new Guid("7CD8ED93-5D81-451F-80AD-314A359C9881"), Direccion = "CARRETERA FEDERAL PACHUCA TUXPAN, COL. CENTRO, VILLA LÁZARO CARDENAS" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("79d5afef-1a31-425f-99c8-af634e48eacc"), Nombre = "UNIDAD DE INVESTIGACION LIBRES", IdMunicipio = new Guid("9A631574-5367-4DBE-B233-D9B4FA2D4CC3"), Direccion = "CALLE LERDO NUMERO 988, LIBRES, PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("501e3e35-a5ee-49eb-aba4-a0fbd485e1ff"), Nombre = "UNIDAD DE INVESTIGACION LOS REYES DE JUAREZ", IdMunicipio = new Guid("E6C3C45C-9C22-4949-A697-2861723754EA"), Direccion = "AVENIDA MERINO FERNANDEZ ENTRE CALLE JUAREZ Y CALLE AYUNTAMIENTO, PRESIDENCIA MUNCIAL, COL. CENTRO, LOS REYES DE JUAREZ, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("785af43d-c780-499a-be4d-58af1cf710a8"), Nombre = "UNIDAD DE INVESTIGACION METLALTOYUCA", IdMunicipio = new Guid("13E0D93F-8BAD-4E1A-98FD-5C9F1B28E1C1"), Direccion = "AVENIDA REYES GARCIA 57 COLONIA ERMITA, METLALTOYUCA, PUEBLA. CP 73000" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("e739f756-a007-4be9-805a-5ac6a33a506b"), Nombre = "UNIDAD DE INVESTIGACION OCOYUCAN", IdMunicipio = new Guid("E7B9F2D3-0FDC-4659-8E39-F1AFE19616A2"), Direccion = "PLAZA PRINCIPAL S/N PLANTA BAJA, PALACIO MUNICIPAL, COL. CENTRO, SANTA CLARA OCOYUCAN" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("01da2664-dfd1-4e84-99e8-bc8a45783ae7"), Nombre = "UNIDAD DE INVESTIGACION ORIENTAL", IdMunicipio = new Guid("DC6CDEFC-C85A-48CC-8903-C4F6667D3FEB"), Direccion = "AV. AYUNTAMIENTO NO. 3 COL. CENTRO CP 75020" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("d740ee67-9128-4fd7-9b3c-6c08e78c626f"), Nombre = "UNIDAD DE INVESTIGACION ORIENTE", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "PROLONGACIÓN 16 ORIENTE ESQ. CON LIBRAMIENTO A TEHUACAN COL. MEXICO 68" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("cd3fd0cd-9bb7-43f0-b9ec-9c4ab6c8c9ed"), Nombre = "UNIDAD DE INVESTIGACION PALMAR DE BRAVO", IdMunicipio = new Guid("45D33258-4F97-4CED-99A1-467449EF159D"), Direccion = "CALLE NICOLAS BRAVO #504 COL. CENTRO PLAMAR DE BRAVO " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("fa3ceab8-6b49-4b21-9797-f160ae57de0f"), Nombre = "UNIDAD DE INVESTIGACION PIAXTLA", IdMunicipio = new Guid("4FD1F509-0631-4439-BF51-FB8DFC615FA5"), Direccion = "PLAZA EXPLANADA PALACIO MUNICIPAL S/N COL. CENTRO PRIMER PISO" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("25b9c1c0-920d-4c08-8043-378a8bd45867"), Nombre = "UNIDAD DE INVESTIGACION SAN GABRIEL CHILAC", IdMunicipio = new Guid("A7DD00AE-A69C-4B94-9B44-D09029D2E493"), Direccion = "AVENIDA NIÑOS HEROES SIN NUMERO COLONIA EL SOL, SAN GABRIEL CHILAC, PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("a019dc1d-64a3-47f6-9721-196c05c098ea"), Nombre = "UNIDAD DE INVESTIGACION SAN PEDRO CHOLULA", IdMunicipio = new Guid("8CD95BF0-A260-4E8B-9306-126C117E76A3"), Direccion = "CALLE 15 NORTE SIN NÚMERO, SEGUNDO PISO, SAN MATÍAS COCOYOTLA, SAN PEDRO CHOLULA, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("c09bc7f1-30a5-4178-8db8-12e6f999fd0d"), Nombre = "UNIDAD DE INVESTIGACION SANTA RITA TLAHUAPAN", IdMunicipio = new Guid("F6B2C9A2-A8A0-457F-A618-F4FED4403FF6"), Direccion = "CALLE MIGUEL HIDALGO S/N COL. CENTRO 74100, SANTA RITA TLAHUAPAN, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("54e9c4e9-2ca0-4f44-8a24-d370717835fe"), Nombre = "UNIDAD DE INVESTIGACION SANTIAGO MIAHUATLAN", IdMunicipio = new Guid("070DD2BB-10CF-411B-B5E5-FCAA42DE9656"), Direccion = "11 PONIENTE ENTRE 1 SUR Y AV. NACIONAL, SANTIAGO MIAHUATLAN, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("6f818939-e2c5-4e99-b61a-ba2c7f8b737e"), Nombre = "UNIDAD DE INVESTIGACION TECALI DE HERRERA", IdMunicipio = new Guid("8A115E57-7789-4DB1-B4CD-961CC0CB50F8"), Direccion = "CALLE DE HERRERA S/N COL. CENTRO, TECALI DE HERRERA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("2c83cc3f-3770-49cb-b39e-b21dade633cf"), Nombre = "UNIDAD DE INVESTIGACION TECAMACHALCO", IdMunicipio = new Guid("16656BD5-EA70-46A9-ADC2-ACD89CC2FB63"), Direccion = "CALLE 10 SUR 507, BARRIO DE SAN JOSE, TECAMACHALCO, PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("d1faf628-ac7f-49da-b722-62f25a7c4e30"), Nombre = "UNIDAD DE INVESTIGACION TEHUITZINGO", IdMunicipio = new Guid("69DD05ED-5BB1-4F47-BC2C-EE48F63E2339"), Direccion = "CALLE LA PRESA SECCIÓN TERCERA, TEHUITZINGO , PUEBLA " });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("dd30046a-76c0-4f63-8db2-eb6bbbf0e938"), Nombre = "UNIDAD DE INVESTIGACION TEPANCO", IdMunicipio = new Guid("C7FD150D-2594-4B43-BAED-CBDD53BE44D6"), Direccion = "PRIV. 8 PONIENTE S/N COL. CENTRO 75800, TEPANCO DE LOPEZ, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("8a7f78ea-6555-4d8e-9e69-e6b0e83cd485"), Nombre = "UNIDAD DE INVESTIGACION TEPATLAXCO", IdMunicipio = new Guid("5910D6E7-8C16-4598-9630-1F59D48A71D7"), Direccion = "2 SUR ESQUINA CON 9 ORIENTE S/N COL. CENTRO, TEPATLAXCO DE HIDALGO, PRIMER PISO" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("f7939e6d-a34b-44a6-a04d-b854420fbe98"), Nombre = "UNIDAD DE INVESTIGACION TEPEACA", IdMunicipio = new Guid("D5B17B0B-1B1C-4B65-983D-113AD6D561FB"), Direccion = "AVENIDA HIDALGO NÚMERO 509 A, TEPEACA PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("f9516462-49ab-431b-a73a-47f0bec22c41"), Nombre = "UNIDAD DE INVESTIGACION TEPEOJUMA", IdMunicipio = new Guid("B62BFED7-4C62-41E0-BFB2-10CA87DB6E91"), Direccion = "CALLE IRINEO VAZQUEZ, NÚMERO 1, TEPEOJUMA, PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("9f34bc66-78d0-4be8-8e30-452182d46a25"), Nombre = "UNIDAD DE INVESTIGACION TEPEXI DE RODRIGUEZ", IdMunicipio = new Guid("D94A72C8-8670-4344-AB47-A78C2FEFADEF"), Direccion = "CALLE 5 DE FEBRERO PLAZA COMUNITARIA PROF .ABEL CRUZ GARCIA , NÚMERO 3  COL CENTRO, TEPEXI DE RODRIGUEZ PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("bae03e06-74f3-489e-af60-2188479ccf33"), Nombre = "UNIDAD DE INVESTIGACION TEPEYAHUALCO", IdMunicipio = new Guid("088E4526-C5B8-442B-AA82-96D5C4BB294B"), Direccion = "CALLE PRIMERA DE VENUSTIANO CARRANZA Y CALLE PRIMERA MORELOS S/N TEPEYAHUALCO, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("e907cf9a-97f7-442c-bef2-e495f34b86f8"), Nombre = "UNIDAD DE INVESTIGACION TETELA DE OCAMPO", IdMunicipio = new Guid("609EBFC5-4B53-46B3-95D5-00D1952F7509"), Direccion = "7 PONIENTE #1, COLONIA CENTRO, TETELA DE OCAMPO, PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("530afb88-3b40-4ed6-be86-2600a33d2a24"), Nombre = "UNIDAD DE INVESTIGACION TLACOTEPEC", IdMunicipio = new Guid("E455C8EE-FE22-4913-A6C0-2B206E2CC8E8"), Direccion = "PLAZA COMUNITARIA CALLE AGUASCALIENTES SIN NUMERO COLONIA CENTRO 75680" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("e8b7fb31-98e3-4b6a-b776-acda0d952390"), Nombre = "UNIDAD DE INVESTIGACION TLALTENANGO", IdMunicipio = new Guid("3A74CE88-BA94-4988-BB2B-434A9C208D28"), Direccion = "REAL DE SAN PEDRO NO 15 COL. CENTRO, C.P.72600, TLALTENANGO, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("2c48c30e-9099-453a-b1e1-8de48c6d4805"), Nombre = "UNIDAD DE INVESTIGACION TLAOLA", IdMunicipio = new Guid("71222470-32E9-4F76-BA77-6AF9E2C98D57"), Direccion = "ESQUINA QUE FORMAN LAS CALLES MORELOS Y CUAUHTEMOC NÚMERO 1, TLAOLA, PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("5004659a-5508-4a62-ad33-0c6e2cb3dac5"), Nombre = "UNIDAD DE INVESTIGACION TLAPANALA", IdMunicipio = new Guid("A68B6BB8-07EA-49A9-BF68-2CEC60A131CE"), Direccion = "PALACION MUNICIPAL S/N TLAPANALA PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("01c23a63-26bb-415b-a6fd-4af5372ebd1b"), Nombre = "UNIDAD DE INVESTIGACION VALSEQUILLO", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "BOULEVARD VALSEQUILLO ESQU. 20 DE NOVIEMBRE COL. SAN BALTAZAR CAMPECHE, PUEBLA,PUE" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("0161bbe8-4f29-4f18-a7c1-96a1283dd01b"), Nombre = "UNIDAD DE INVESTIGACION VILLA FRONTERA", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CALLE FRANCISCO I. MADERO NO. 07 COL. CENTRO, SAN PABLO XOCHIMEHUACAN" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("e14cfd93-36d2-4289-8fb1-f0fe129679eb"), Nombre = "UNIDAD DE INVESTIGACION VIRTUAL PREDENUNCIA EL CARMEN", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CALLE 21 ORIENTE NO.404, COL. EL CARMEN, PUEBLA,PUE" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("4a6de92d-7189-4657-9060-4b07e3686ac4"), Nombre = "UNIDAD DE INVESTIGACION VW", IdMunicipio = new Guid("9005DDCE-0399-4CAB-8496-456B816BCFEB"), Direccion = "AV. SAN LORENZO ALMECATLA SIN NUMERO PLAZA MOVAR SANCTORUM" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("8a730942-5d46-4e1e-a27d-fd17e4117669"), Nombre = "UNIDAD DE INVESTIGACION XICOTEPEC DE JUAREZ", IdMunicipio = new Guid("8E77A494-CE8B-4500-B883-CB24E774D350"), Direccion = "CALLE 2 DE ABRIL 117 COLONIA CENTRO, XICOTEPEC DE JUAREZ, PUEBLA." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("207ec592-2a4f-4366-8123-44bc5533559b"), Nombre = "UNIDAD DE INVESTIGACION Y MEDIOS ALTERNATIVOS", IdMunicipio = new Guid("3910B3BD-9281-4568-BDA3-942A24C94B9C"), Direccion = "AV. 5 DE MAYO NO.1 EXTERIOR DE LA PRESIDENCIA MUNICIPAL, GUADALUPE VICTORIA , PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("919ff401-69e3-452e-b7bf-fbdd4b379af0"), Nombre = "UNIDAD DE INVESTIGACION ZACAPOAXTLA", IdMunicipio = new Guid("7EC98118-CD95-440E-AE88-3E8FBB68486B"), Direccion = "CALLE 2 DE ABRIL SUR, EDIFICIO REVOLUCIÓN ESQUINA IGNACIO COETO ,COL. CENTRO ZACAPOAXTLA PUEBLA" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("602fdfb4-55ab-4fbc-bcca-d38c5d3a6142"), Nombre = "UNIDAD DE INVESTIGACION ZARAGOZA", IdMunicipio = new Guid("D62AF5EC-82E5-4515-8E19-04C8A10C9161"), Direccion = "CALLE 3 ORIENTE 1211 COLONIA SANTA ANA, ZARAGOZA, PUE." });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("064da5c0-cc5a-4310-bff8-7a05ccdd8bd6"), Nombre = "UNIDAD DE INVESTIGACION ZOQUITLAN", IdMunicipio = new Guid("B6532A44-F248-4575-BA87-B6374CF2322F"), Direccion = "CALLE JUVENTUD S/N COL. CENTRO" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("f7170f25-799e-495c-87e8-317d77327597"), Nombre = "UNIDAD ESPECIALIZADA ADSCRITA A LA FISCALIA METROPOLITANA (JUZGADOS PENALES)", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CALLE 12 ORIENTE NO. 608 COL. CENTRO ,PUEBLA, PUE" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("ec5df6f8-6685-4a7a-9a68-b7723ac314dc"), Nombre = "UNIDAD ESPECIALIZADA EN INVESTIGACION DE ROBO DE VEHICULOS (OCRA)", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CAMINO AL BATÁN KM2.5 COL.LOMAS DE SAN MIGUEL PUEBLA,PUE. CP.: 72573" });
            modelBuilder.Entity<Inmueble>().HasData(new Inmueble { Id = new Guid("31433e7f-7262-4fa5-8a40-98979f893269"), Nombre = "UNIDAD INTEGRAL DE SERVICIOS EL ALTO", IdMunicipio = new Guid("D708E960-E465-4B40-9F31-1C97C21D5B8A"), Direccion = "CALLE 8 ORIENTE, NUMERO 1007, COLONIA SAN FRANCISCO, PUEBLA, PUE. " });
